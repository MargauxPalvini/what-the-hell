...
class Tmdb
  ...
  def self.movie_from_title(movie_title)
    ...
    def self.actor_from_name actor_name
    url = "https://api.themoviedb.org/3/search/person?api_key=#{@api_key}&language=en-US&query=#{actor_name}&page=1&include_adult=false"
